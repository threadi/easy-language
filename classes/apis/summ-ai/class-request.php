...
class Request {
	...
	public function send(): void {
		...
		$supported_target_languages = Summ_AI::get_instance()->get_supported_target_languages();
        ...
        if( 'POST' === $this->get_method() ) {
            ...
            $data['user']                   = Summ_AI::get_instance()->get_contact_email();
            $data['is_test']                = false;
        ...
        Log_Api::get_instance()->add_log( 'summ-ai', $this->http_status, print_r( $args, true ), print_r( 'HTTP-Status: '.$this->get_http_status().'<br>'.$this->response, true ) );
