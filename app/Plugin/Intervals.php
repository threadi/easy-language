<?php
/**
 * File with the handler for our own intervals.
 *
...
class Intervals {
	...
	private function get_intervals(): array {
		// add the list.
		$list = array(
			'\easyLanguage\Plugin\Intervals\Minutly15',
			'\easyLanguage\Plugin\Intervals\Minutly20',
			'\easyLanguage\Plugin\Intervals\Minutly30',
			'\easyLanguage\Plugin\Intervals\Hourly',
			'\easyLanguage\Plugin\Intervals\Hourly2',
			'\easyLanguage\Plugin\Intervals\Hourly3',
			'\easyLanguage\Plugin\Intervals\Hourly4',
			'\easyLanguage\Plugin\Intervals\Daily',
			'\easyLanguage\Plugin\Intervals\Weekly',
		);
		 ...
		 */
		return apply_filters( 'easy_language_intervals', $list );
	}
