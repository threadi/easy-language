<?php
/**
 * Tests for class easyLanguage\Apis\Summ_Ai\Simplifications.
 *
...
/**
 * Object to test functions in class easyLanguage\Apis\Summ_Ai\Simplifications.
 */
class Simplifications extends easyLanguageTests {
	 ...
	 * The object to test.
	 *
	 * @var \easyLanguage\Apis\Summ_Ai\Simplifications
	 */
	private \easyLanguage\Apis\Summ_Ai\Simplifications $object;
	...
	public function set_up(): void {
		...
		$this->object = \easyLanguage\Apis\Summ_Ai\Simplifications::get_instance();
	...
	public static function filter_requests( bool|array $false, array $parsed_args, string $url ): bool|array {
		...
		if( 'POST' === $parsed_args['method'] && str_starts_with( $url, ( new Simplifications )->get_api_obj()->get_api_url() ) ) {
