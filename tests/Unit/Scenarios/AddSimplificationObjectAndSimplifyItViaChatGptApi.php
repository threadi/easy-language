 ...
 */
class AddSimplificationObjectAndSimplifyItViaChatGptApi extends easyLanguageTests {
	/**
	 * The test text.
	 *
	 * @var string
	 */
	private string $test_title = 'Hallo ChatGPT';
	 ...
	 * @var string
	 */
	private string $test_text = '<p>Das ist ein kompliziertes Beispiel für Text für ChatGPT.</p>';
	 ...
	 *
	 * @var \easyLanguage\Apis\ChatGpt\ChatGpt
	 */
	private \easyLanguage\Apis\ChatGpt\ChatGpt $api_obj;
	...
	public function set_up(): void {
		...
		// get the API object.
		$this->api_obj = \easyLanguage\Apis\ChatGpt\ChatGpt::get_instance();
	}
	...
	public static function filter_requests( bool|array $false, array $parsed_args, string $url ): bool|array {
		...
		if( 'POST' === $parsed_args['method'] && str_starts_with( $url, ( new AddSimplificationObjectAndSimplifyItViaChatGptApi() )->get_api_obj()->get_api_url() ) ) {
			// get our example response.
			$json = \easylanguage\Plugin\Helper::get_wp_filesystem()->get_contents( UNIT_TESTS_DATA_PLUGIN_DIR . 'chatgpt.json' );
	 ...
	 *
	 * @return \easyLanguage\Apis\ChatGpt\ChatGpt
	 */
	public function get_api_obj(): \easyLanguage\Apis\ChatGpt\ChatGpt {
		return \easyLanguage\Apis\ChatGpt\ChatGpt::get_instance();
	}
}
