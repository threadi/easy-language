 ...
 */
class AddSimplificationObjectAndSimplifyItViaSummAiApi extends easyLanguageTests {
	/**
	 * The test text.
	 *
	 * @var string
	 */
	private string $test_title = 'Hallo SUMM AI';
	 ...
	 * @var string
	 */
	private string $test_text = '<p>Das ist ein kompliziertes Beispiel für Text für SUMM AI.</p>';
	 ...
	 * @var string
	 */
	private string $target_language = 'de_LS';

	/**
	 * The API object to use it for simplifications.
	 *
	 * @var \easyLanguage\Apis\Summ_Ai\Summ_Ai
	 */
	private \easyLanguage\Apis\Summ_Ai\Summ_Ai $api_obj;
	...
	public function set_up(): void {
		...
		// get the API object.
		$this->api_obj = \easyLanguage\Apis\Summ_Ai\Summ_Ai::get_instance();
	}
	...
	/**
	 * Test to create and simplify an object via SUMM AI.
	 *
	...
	public static function filter_requests( bool|array $false, array $parsed_args, string $url ): bool|array {
		...
		if( 'POST' === $parsed_args['method'] && str_starts_with( $url, ( new AddSimplificationObjectAndSimplifyItViaSummAiApi() )->get_api_obj()->get_api_url() ) ) {
			// get our example response.
			$json = \easylanguage\Plugin\Helper::get_wp_filesystem()->get_contents( UNIT_TESTS_DATA_PLUGIN_DIR . 'summ_ai.json' );
	 ...
	 *
	 * @return \easyLanguage\Apis\Summ_Ai\Summ_Ai
	 */
	public function get_api_obj(): \easyLanguage\Apis\Summ_Ai\Summ_Ai {
		return \easyLanguage\Apis\Summ_Ai\Summ_Ai::get_instance();
	}
}
