 ...
 */
class Apis extends WP_UnitTestCase {
	...
	public function test_get_active_api_is_capito(): void {
		...
		$this->assertInstanceOf( \easyLanguage\Apis\Capito\Capito::class, $active_api );
	}
	...
	public function test_get_active_api_is_chatgpt(): void {
		...
		$active_api = \easyLanguage\Plugin\Apis::get_instance()->get_active_api();
		$this->assertInstanceOf( \easyLanguage\Apis\ChatGpt\ChatGpt::class, $active_api );
	}
	...
	public function test_get_active_api_is_summ_ai(): void {
		...
		$active_api = \easyLanguage\Plugin\Apis::get_instance()->get_active_api();
		$this->assertInstanceOf( \easyLanguage\Apis\Summ_Ai\Summ_Ai::class, $active_api );
	}
	 ...
	 * @return void
	 */
	public function test_get_api_by_name(): void {
